      ...
      <el-row :gutter="20">
         ...
         <el-col :span="4" :xs="24">
            ...
            <div class="type-card-box">
               <div v-for="(item, index) in alarmTypes" :key="index" class="monitor-item-type-box">
...
const alarmTypes = ref([
   { title: '服务器异常告警', icon: 'fa-server' },
   { title: '网络连接告警', icon: 'fa-wifi' },
   { title: '磁盘空间告警', icon: 'fa-hdd' },
   { title: '内存使用告警', icon: 'fa-memory' },
   { title: 'CPU负载告警', icon: 'fa-microchip' },
   { title: '应用错误告警', icon: 'fa-exclamation-triangle' }
]);
