...
import com.alinesno.infra.ops.watcher.collector.service.*;
...
//        IMetricsSummaryService metricsSummaryService = SpringUtil.getBean(IMetricsSummaryService.class) ;
        ...
        metricsGaugeService.saveGauge(list.get("metricsGauge"));
		metricsSumService.saveSum(list.get("metricsSum"));
//		metricsHistogramService.saveHistogram(list.get("metricsHistogram"));
//		metricsExponentialHistogramService.saveHistogram(list.get("metricsExponentialHistogram"));
//		metricsSummaryService.saveSummary(list.get("metricsSummary"));
    }
