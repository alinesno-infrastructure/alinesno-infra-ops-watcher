...
public class WatcherCollectorApplication extends TelemetryServer implements CommandLineRunner  {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        SpringApplication.run(WatcherCollectorApplication.class, args);
